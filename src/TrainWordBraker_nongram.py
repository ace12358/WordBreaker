...
def init_model(vocab_size, char_type_size):
    model = FunctionSet(
        ...
        hidden1=F.Linear(window * (embed_units + char_type_embed_units)*1 + hidden_units, hidden_units),
        i_gate=F.Linear(window * (embed_units + char_type_embed_units)*1 + hidden_units, hidden_units),
        f_gate=F.Linear(window * (embed_units + char_type_embed_units)*1 + hidden_units, hidden_units),
        o_gate=F.Linear(window * (embed_units + char_type_embed_units)*1 + hidden_units, hidden_units),
